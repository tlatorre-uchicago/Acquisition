...
dpo = rm.open_resource('TCPIP::192.168.0.137::INSTR')
...
if runNumberParam == -1:
	...
	RunNumberFile = '/home/lab-cpt03/KeysightScopeAcquisition/Acquisition/runNumber.txt'
...
log_path = '/home/lab-cpt03/KeysightScopeAcquisition/Acquisition/Logbook.txt'
run_log_path = '/home/lab-cpt03/KeysightScopeAcquisition/AcquisitionRunLog.txt'
...
print('Bandwidth set to 5 MHz')
logf.write('Bandwidth set to 5 MHz \n')
...
if savewaves: 
	output_path = 'C:\\Users\\Public\\Documents\\Agilentwaveform\\20210421\\'
	...
	dpo.write(':DISK:SAVE:WAVeform CHANnel1 ,"'+output_path+'Wavenewscope_CH1_run%s",h5,ON'%(runNumber))
